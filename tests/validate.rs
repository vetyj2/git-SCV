...
fn baseline() -> RunData {
    ...
    RunData {
        ...
        static_preflight_summary: StaticPreflightSummaryArtifact {
            schema_version: sv(),
            run_id: rid(),
            ...
            honest_status: "시험".into(),
            next_required_artifacts: vec![],
            user_warning: "시험".into(),
        },
        sub_slices: SubSliceArtifact {
            ...
            policy: SubSlicePolicy {
                ...
                max_estimated_tokens_per_sub_slice: 2000,
                split_strategy: "시험".into(),
                raw_content_stored: false,
            },
            totals: SubSliceTotals {
                parent_slices: 0,
                sub_slices: 0,
                blocked_sub_slices: 0,
                oversized_parent_slices: 0,
            },
            sub_slices: vec![],
            note: "시험".into(),
        },
        analysis_inputs: AnalysisInputsArtifact {
            ...
            untrusted_content_notice: "시험".into(),
            inputs: vec![],
            excluded: vec![],
            raw_content_stored: false,
        },
        analysis_state: AnalysisStateArtifact {
            schema_version: sv(),
            run_id: rid(),
            analysis_stage: AnalysisStage::PendingUnitAnalysis,
        ...
        analysis_events: vec![AnalysisEvent {
        ...
        llm_backend: LlmBackendArtifact {
            schema_version: sv(),
            run_id: rid(),
            analysis_stage: AnalysisStage::PendingUnitAnalysis,
        ...
        gpt_work_order: GptWorkOrderArtifact {
            schema_version: sv(),
            run_id: rid(),
            analysis_stage: AnalysisStage::PendingUnitAnalysis,
            ...
            credential_policy: "시험".into(),
            oauth_token_stored: false,
            oauth_token_forwarded: false,
            raw_content_stored: false,
            target_repo_commands_executed: false,
            ordered_steps: vec![GptWorkOrderStep {
                order: 1,
                step_id: "WO-001".into(),
                title: "시험".into(),
                gpt_action: "시험".into(),
                command: Some("git-scv watch <run-dir>".into()),
                reads: vec!["brief.md".into()],
                writes: vec![],
                required_before: vec![],
                success_criteria: vec![],
                blocked_by: vec![],
            }],
            stop_conditions: vec![NO_EXEC_SENTENCE.into()],
            resume_strategy: vec![],
            required_input_artifacts: vec![],
            expected_output_artifacts: vec![],
            gpt_handoff_prompt: "시험".into(),
            no_exec_statement: NO_EXEC_SENTENCE.into(),
        },
        analysis_jobs: vec![AnalysisJob {
            job_id: "J00001".into(),
            run_id: rid(),
            input_id: Some("AI00001".into()),
            sub_slice_id: "SS00001".into(),
            path: "README.md".into(),
            included_range: "bytes:0-0".into(),
            status: "queued".into(),
            ...
            result_ref: None,
            source_fingerprint_hash: "sha256:unknown".into(),
            work_order_sha256: "sha256:unknown".into(),
            raw_content_stored: false,
            target_repo_commands_executed: false,
        }],
        codex_invocation_receipts: vec![],
        ...
        analysis_map: RepoAnalysisMapArtifact {
            schema_version: sv(),
            run_id: rid(),
