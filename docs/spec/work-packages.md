...
| WP7 | artifacts.rs, report.rs, dependencies.rs, sectors.rs, sensitive.rs, gates.rs, slices.rs, review.rs, web_report.rs, graph.rs, visualization.rs, synthesis.rs, orchestrator.rs, analysis_runtime.rs | 0900-artifacts.md 1–2절 | T06, T10 | 45개 inspect/analysis 산출물, 결정적 바이트, 리포트/시각화 템플릿 일치 |
...
| T06 | tests/integration.rs | 고정 저장소 → 45개 inspect/analysis 산출물, 스키마 필수 필드, 승인 게이트·읽기 슬라이스·보안 요약·그래프·시각화·합성·웹 리포트 확인 | 1302, 1303, 8002–8005 |
...
| 8002 inspect/analysis 산출물 45개 생성 | T06 |
