...
| --- | --- |
| "Install Git-SCV" | `scripts/git-scv-hermes.sh install` or `cargo install --git https://github.com/vetyj2/git-SCV --tag v0.3.4 --locked` |
| "Update Git-SCV" | `scripts/git-scv-hermes.sh update-latest` or `cargo install --git https://github.com/vetyj2/git-SCV --tag v0.3.4 --locked --force` |
